...
namespace Проект.AbstractFactory.Factory
{
    class USA : IAllInAll
    {
        ...
        public override Content CreateUTicket1()
        {
            return new LUSA();
        }
        public override Content CreateUTicket2()
        {
            return new LUSA();
        }
        public override Content CreateUTicket3()
        {
            return new LUSA();
        }
        public override Content CreateUTicket4()
        {
            return new LUSA();
        }
        public override Content CreateUTicket5()
        {
            return new LUSA();
        }
        public override Content CreateUTicket6()
        {
            return new LUSA();
        }
        public override Content CreateUTicket7()
        {
            return new LUSA();
        }
        public override Content CreateUTicket8()
        {
            return new LUSA();
        }
        public override Content CreateUTicket9()
        {
            return new LUSA();
        }
        /////////////////////////////////////
